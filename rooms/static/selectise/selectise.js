...
function(a, b) {
    ...
    a.extend(w.prototype, {
        ...
        refreshOptions: function(b) {
            ...
            if (y.html(o),
            u.settings.highlight && (y.removeHighlight(),
        ...
        addItems: function(b, c) {
            ...
            for (var f = a.isArray(b) ? b : [b], e = 0, g = f.length; e < g; e++)
                this.isPending = e < g - 1,
                this.addItem(f[e], c);
            var h = this.$control[0];
            h.insertBefore(this.buffer, h.firstChild),
            this.buffer = null
        },
        ...
        close: function() {
            ...
            a.isBlurring || a.$control_input.blur()),
            a.isOpen = !1,
            a.$dropdown.hide(),
        ...
        insertAtCaret: function(a) {
            ...
            0 === b ? d.insertBefore(c, d.firstChild) : d.insertBefore(c, d.childNodes[b]),
            this.setCaret(b + 1)
        },
        ...
        destroy: function() {
            ...
            0 == --w.count && w.$testInput && (w.$testInput.remove(),
            w.$testInput = void 0),
            a(window).off(c),
            a(document).off(c),
        ...
        render: function(b, c) {
            ...
            "option" === b || "option_create" === b ? c[h.settings.disabledField] || f.attr("data-selectable", "") : "optgroup" === b && (e = c[h.settings.optgroupValueField] || "",
            f.attr("data-group", e),
